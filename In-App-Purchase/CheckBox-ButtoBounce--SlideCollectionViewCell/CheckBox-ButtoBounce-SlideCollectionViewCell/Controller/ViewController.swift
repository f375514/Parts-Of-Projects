...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var view1LeadConst: NSLayoutConstraint!
    @IBOutlet weak var view1TrailConst: NSLayoutConstraint!
    @IBOutlet weak var continueLeadConst: NSLayoutConstraint!
    @IBOutlet weak var continueTrailConst: NSLayoutConstraint!
    ...
    override func viewDidLayoutSubviews() {
        ...
        if view.frame.width <= 380 {
            ...
            //428
        if view.frame.width >= 435 {
            view1LeadConst.constant = 230
            view1TrailConst.constant = 230
            continueLeadConst.constant = 300
            continueTrailConst.constant = 300
        }
    ...
    func corenerRadius(){
        let viewArr = [view1, view2, view3, view4, smallLabel, smallLabel2, vip]
        for v in viewArr {
            v?.layer.cornerRadius = 10
            v?.layer.masksToBounds = true
        }
        submitButton.layer.cornerRadius = 25
        img0.layer.cornerRadius = 12.5
        img1.layer.cornerRadius = 12.5
        img2.layer.cornerRadius = 12.5
        img3.layer.cornerRadius = 12.5
    }
...
//    }
    ...
    @IBAction func buttonAction(_ sender: UIButton){
        ...
        case 0:
            ...
            img1.tintColor = UIColor.systemGray4
            img2.tintColor = UIColor.systemGray4
            img3.tintColor = UIColor.systemGray4
            ...
            break
        case 1:
            img0.tintColor = UIColor.systemGray4
